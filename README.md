...
For Llama 3.2 1B, as GQA, it is 'hidden_size = (num_kv_heads * head_dim)', so I'm making sure to plug that in and not 'hidden_size = (num_heads * head_dim)' 
...
1) max_batch_size = 4   
2) max_seq_len = 256    
3) hidden_size = num_kv_heads * head_dim = 8 * 64 = 512 
4) num_layers = 16   
